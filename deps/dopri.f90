...
double precision :: xold8
double precision :: hout8
double precision :: xold5
double precision :: hout5
...
double precision, intent(in out)         :: safe
double precision, intent(in)             :: beta
double precision, intent(in)             :: fac1
double precision, intent(in)             :: fac2
double precision, intent(out)            :: y1(n)
double precision, intent(in out)         :: k1(n)
double precision, intent(in out)             :: k2(n)
double precision, intent(in out)             :: k3(n)
double precision, intent(in out)         :: k4(n)
double precision, intent(in out)             :: k5(n)
double precision, intent(in out)             :: k6(n)
double precision, intent(out)            :: ysti(n)
double precision, intent(out)            :: cont(5*nrd)
...
double precision :: a61
double precision :: a62
double precision :: a63
double precision :: a64
double precision :: a65
double precision :: a71
double precision :: a73
double precision :: a74
double precision :: a75
double precision :: a76
double precision :: d1
double precision :: d3
double precision :: d4
double precision :: d5
double precision :: d6
double precision :: d7
double precision :: facold
double precision :: fac11
double precision :: fac
double precision :: expo1
double precision :: facc1
double precision :: facc2
double precision :: posneg
double precision :: atoli
double precision :: rtoli
double precision :: hlamb
double precision :: hnew
double precision :: err
double precision :: sk
double precision :: stnum
double precision :: stden
double precision :: xph
double precision :: yd0
double precision :: ydiff
double precision :: bspl
integer :: iasti
integer :: iord
integer :: irtrn
integer :: i
...
double precision function hinit5(n,fcn,x,y,posneg,f0,f1,y1,iord,  &
    hmax,atol,rtol,itol,tnk)
! ----------------------------------------------------------
...
double precision, intent(in out)         :: posneg
double precision, intent(in)             :: f0(n)
double precision, intent(in out)         :: f1(n)
double precision, intent(out)            :: y1(n)
...
double precision :: dnf
double precision :: dny
double precision :: der2
double precision :: der12
double precision :: atoli
double precision :: rtoli
double precision :: sk
double precision :: h
...
double precision, intent(in)             :: con(5*nd)
...
double precision, intent(out)            :: c4
double precision, intent(out)            :: c5
double precision, intent(out)            :: e1
double precision, intent(out)            :: e3
double precision, intent(out)            :: e4
double precision, intent(out)            :: e5
double precision, intent(out)            :: e6
double precision, intent(out)            :: e7
double precision, intent(out)            :: a21
double precision, intent(out)            :: a31
double precision, intent(out)            :: a32
double precision, intent(out)            :: a41
double precision, intent(out)            :: a42
double precision, intent(out)            :: a43
double precision, intent(out)            :: a51
double precision, intent(out)            :: a52
double precision, intent(out)            :: a53
double precision, intent(out)            :: a54
double precision, intent(out)            :: a61
double precision, intent(out)            :: a62
double precision, intent(out)            :: a63
double precision, intent(out)            :: a64
double precision, intent(out)            :: a65
double precision, intent(out)            :: a71
double precision, intent(out)            :: a73
double precision, intent(out)            :: a74
double precision, intent(out)            :: a75
double precision, intent(out)            :: a76
...
double precision, intent(out)            :: d7
c2=0.2d0
c3=0.3d0
c4=0.8d0
c5=8.d0/9.d0
...
double precision, intent(in out)         :: k4(n)
double precision, intent(in out)         :: k5(n)
double precision, intent(in)             :: k6(n)
double precision, intent(in)             :: k7(n)
double precision, intent(in)             :: k8(n)
double precision, intent(in)             :: k9(n)
double precision, intent(in)             :: k10(n)
double precision, intent(out)            :: y1(n)
double precision, intent(out)            :: cont(8*nrd)
integer, intent(in)                      :: icomp(nrd)
integer, intent(in out)                  :: nrd
integer, intent(out)                     :: nfcn
integer, intent(in out)                  :: nstep
...
double precision function hinit(n,fcn,x,y,posneg,f0,f1,y1,iord,  &
    hmax,atol,rtol,itol,tnk)
! ----------------------------------------------------------
! ----  computation of an initial step size guess
! ----------------------------------------------------------
...
integer, intent(in)                      :: ii
double precision, intent(in)         :: x
double precision, intent(in)             :: con(8*nd)
integer, intent(in)                      :: icomp(nd)
integer, intent(in)                      :: nd
